            ...
            <x-filament::section class="card">
                ...
                <div class="card-content">
                    ...
                    <div class="row martop-1 flex flex-wrap">
                        <x-filament::button class="text-sm btn " tag="a" href="penilaian_kehadiran/{{$is->student->id}}" color="primary">Evaluasi Kehadiran</x-filament::button>
                        <x-filament::button class="text-sm btn " tag="a" href="daftar_siswa_bimbingan/logbook_siswa/{{$is->student->id}}" color="info">Logbook Siswa</x-filament::button>
                    </div>
                </div>
                </div>
            </x-filament::section>
